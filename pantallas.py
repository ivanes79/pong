...
class Partida:
    ...
    def resultado_final(self):
        if self.marcador1 > self.marcador2:
            return f"Gana el Jugador 1, resultado Jugador1: {self.marcador1} Jugador2: {self.marcador2}"
        elif self.marcador2 > self.marcador1:
            return f"Gana el Jugador 2, resultado Jugador1: {self.marcador1} Jugador2: {self.marcador2}"
        else:      
